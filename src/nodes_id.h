...
#elif NODE_ID==4
// node-3-0taa
#define LORAWAN_DEV_EUI { 0x70, 0xB3, 0xD5, 0x7E, 0xD0, 0x06, 0xB4, 0x69 }
#elif NODE_ID==5
// node-3-0taa
#define LORAWAN_DEV_EUI { 0x70, 0xB3, 0xD5, 0x7E, 0xD0, 0x06, 0xB4, 0x71 }
#elif NODE_ID==6
// node-3-0taa
#define LORAWAN_DEV_EUI { 0x70, 0xB3, 0xD5, 0x7E, 0xD0, 0x07, 0x77, 0x44 }
#elif NODE_ID==666
// test-node
#define LORAWAN_DEV_EUI { 0x70, 0xB3, 0xD5, 0x7E, 0xD0, 0x07, 0x85, 0x64 }
#endif
